 ...
 *
 * Services:
 *   /set_cleaning_state (asiza_msgs/srv/SetCleaningState):
...
#include "asiza_msgs/srv/set_cleaning_state.hpp"
...
public:
  ...
  {
    service_ = this->create_service<asiza_msgs::srv::SetCleaningState>(
      "/set_cleaning_state",
...
private:
  ...
  void set_cleaning_state_callback(
    const std::shared_ptr<asiza_msgs::srv::SetCleaningState::Request> request,
    std::shared_ptr<asiza_msgs::srv::SetCleaningState::Response> response)
  {
  ...
  rclcpp::Service<asiza_msgs::srv::SetCleaningState>::SharedPtr service_;
};
