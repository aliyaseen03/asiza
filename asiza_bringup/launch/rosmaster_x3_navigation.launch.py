...
def generate_launch_description():
    ...
    package_name_docking = 'asiza_docking'
    package_name_gazebo = 'asiza_gazebo'
    package_name_localization = 'asiza_localization'
    package_name_navigation = 'asiza_navigation'

    # Launch and config file paths
    apriltag_launch_file_path = 'launch/apriltag_dock_pose_publisher.launch.py'
    gazebo_launch_file_path = 'launch/asiza.gazebo.launch.py'
