...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/asiza/asiza_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/asiza_description/share/asiza_description/config',
        robot_name
    )
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'asiza_description'
    urdf_filename = 'asiza.urdf.xacro'
    rviz_config_filename = 'asiza_description.rviz'
